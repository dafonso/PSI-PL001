    	...
    	<div id="wrap">
	        <div class="container">
				...
				<ul class="breadcrumb">
					...
					<li><a href="escolherProdutos.php?category_id=<?=$product->getCategory()->getId();?>"><?=$product->getCategory()->getName();?></a> <span class="divider">/</span></li>
	                    ...
	                    <div class="controls-row">
	                        <div class="span6">
	                            ...
	                            <div class="control-group">
	                                ...
	                                <div class="controls">
	                                    <input type="text" id="inputAddress" name="inputAddress" placeholder="Morada" class="input-xlarge" maxlength="255" value="<?=$customer->getAddresses()->getStreet();?>" required>
	                                </div>
	                            </div>
	                            <div class="control-group">
	                                <label class="control-label" for="inputNIF">Nº Contribuinte</label>
	                                <div class="controls">
	                                    <input type="text" id="inputNIF" name="inputNIF" placeholder="Nº Contribuinte" class="input-xlarge" value="<?=$customer->getNif();?>" required>
	                                </div>
	                            </div>
	                            <div class="control-group">
	                            ...
	                            <div class="control-group" id="ccDetails">
	                                <div class="control-group">
	                                    ...
	                                    <div class="controls">
	                                        ...
	                                        <input type="text" id="inputCardNumber" name="inputCardNumber" name="inputCardNumber"  placeholder="Nº Cartão" class="input-xlarge" maxlength="16" value="<?=$customer->getPayoption()->getCardnr();?>">
	                                    </div>
	                                </div>
	                                <div class="control-group">
	                                    <label class="control-label" for="inputExpiryDate">Data de Expiração</label>
	                                    <div class="controls">
	                                        <input type="text" id="inputExpiryDate" name="inputExpiryDate" name="inputExpiryDate"  placeholder="mm/aa" class="input-small"  value="<?=$customer->getPayoption()->getExpirydate();?>">
	                                    </div>
	                                </div>
	                                <div class="control-group">
	                                    <label class="control-label" for="inputCS">Codigo de Segurança</label>
	                                    <div class="controls">
	                                        <input type="text" id="inputCS" name="inputCS" name="inputCS"  placeholder="123" class="input-small" maxlength="3" value="<?=$customer->getPayoption()->getSecuritycode();?>">
	                                    </div>
	                                </div>
	                            </div>
	                            <div class="control-group span6 offset2" id="paypalDetails" style="display: none;"> 
	                                <input type="text" id="inputPaypalEmail" name="inputPaypalEmail" name="inputPaypalEmail"  placeholder="E-mail PayPal" class="input-xlarge" maxlength="255" value="<?=$customer->getPaypal();?>">
	                            </div> 
	                        </div>
	                        <div class="span6">
	                            <div class="control-group">
	                                ...
	                                <div class="controls">
	                                    <input type="number" id="inputQuantity" name="inputQuantity" name="inputQuantity" placeholder="" class="input-xlarge" min="1" value="1" onchange="updateTotalPrice();">
	                                </div>
	                            </div>
	                            <div class="control-group">
	                                <label class="control-label" for="inputName">Nome</label>
	                                <div class="controls">
	                                    <input type="text" id="inputName" name="inputName" placeholder="Nome" class="input-xlarge" required maxlength="160"  value="<?=$customer->getName();?>">
	                                </div>
	                            </div>
	                            <div class="control-group">
	                                <label class="control-label" for="inputZipcode1">Código Postal</label>
	                                <div class="controls controls-row">
	                                    <input type="text" id="inputZipcode1" name="inputZipcode1" placeholder="Código" class="input-small" maxlength="8" value="<?=$customer->getAddresses()->getPostalcode();?>" required>
	                                    <input type="text" id="inputCity" name="inputCity" placeholder="Localidade" class="input-medium pull-right" maxlength="60" value="<?=$customer->getAddresses()->getCity();?>" required>
	                                </div>
	                            </div>
	                            <div class="control-group">
